...
Path: D:/Git_Repositories/Workspace_AC/.github/agents/Workspace-Rules.md
Authors: Rolf
Version: 1.2.0
Changelog:
- 2026-07-31: Consolidated Workspace-Rules authority, canonical Workspace_AC paths, agent registry requirements, and WorkspaceLog governance logging.
...
global constraints for Workspace_AC.

=====================================================================
2. Scope
=====================================================================
Workspace rules apply to Workspace_AC and to workspace-level control
operations performed from Workspace_AC.

Canonical workspace root:
- D:\Git_Repositories\Workspace_AC

Canonical workspace control directories:
- D:\Git_Repositories\Workspace_AC\.github\agents
- D:\Git_Repositories\Workspace_AC\.copilot
...
- example:
  D:\Git_Repositories\Workspace_AC\.github\agents\Workspace-Rules.md
...
- WorkspaceLog.agent.md writes the canonical governance log to .copilot\Logs\Workspace_AC.log
